...
public class Book {
	...
	private String author;//商家
	private double price;//定价
	private double currPrice;//当前价
	private double discount;//折扣
	private String press;//地区
	private String publishtime;//开始时间
	private int edition;//限购
	private int pageNum;//人均
	private String wordNum;//详细地址
	private String printtime;//刷新时间
	private String booksize;//使用时间
	private String paper;//联系方式
	...
	public Book(String bid, String bname, String author, double price, double currPrice, double discount, String press,
			String publishtime, int edition, int pageNum, String wordNum, String printtime, String booksize, String paper,
